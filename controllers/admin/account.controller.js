...
module.exports.otpPasswordPost = async (req, res) => {
  ...
  // Kiểm tra có tôn tại bản ghi tròn forgotPassword không

  const exitRecord = await ForgotFassword.findOne({
    otp: otp,
    email: email
  })
  ...
  const account = await AcconutAdmin.findOne({
    email: email
  })
  // Tạo token
